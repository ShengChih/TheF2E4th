...
export default function useSlider({ totalRows, maxRowsInContainer }: SliderProps) {
  ...
  const end = start + maxRowsInContainer > totalRows ? totalRows : start + maxRowsInContainer
