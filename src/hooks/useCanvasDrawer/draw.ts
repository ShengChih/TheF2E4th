...
export const preprocessUploadImage = (
  ...
  const newImageData = toGrayscaleImage(context.getImageData(0, 0, newWidth, newHeight))
...
export const removeWhiteBg = (
  ...
  const newImageData = toTransparentImage(context.getImageData(0, 0, image.width, image.height))
