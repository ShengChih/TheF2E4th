...
export const Tasks = [
	...
	},
	{
		...
		subtitle: "Scrum 新手村",
		content: "設計關卡內容與網頁互動效果，透過頁面關卡來呈現知識點，讓挑戰者藉由你設計的內容更了解 Scrum。",
		tipUrl: "https://peppermint-hyacinth-b5e.notion.site/HTML-Draggable-API-SortableJS-b9b75a512f114ff8ad72f4076edeca6b",
		contributeUrl: "https://2022.thef2e.com/works/create",
		...TitansoftLogo()
	},
]