...
interface TaskCardProps {
  ...
  forwardTips?: (e: MouseEvent | KeyboardEvent) => void
  forwardContribute?: (e: MouseEvent | KeyboardEvent) => void
}
...
const TaskCardComponent: ForwardRefRenderFunction<TaskCardHandle, TaskCardProps> = (
  { className, title, subtitle, content, EnterpriseLogo, TaskLogo, forwardTips, forwardContribute },
  forwardref,
) => {
