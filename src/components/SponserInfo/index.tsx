...
export default function SponserInfo() {
	return (
		<>
			...
			<div className={`text-center font-medium font-sans text-[#38241B] desktop:leading-[62.26px] desktop:text-[43px] desktop:mt-[42.17px] desktop:w-[996px] desktop:h-[62px] desktop:tracking-[25px]`}>年度最強合作，三大關卡來襲</div>
