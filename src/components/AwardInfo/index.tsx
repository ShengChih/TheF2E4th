		...
		<section ref={SectionRef} className={`w-full desktop:h-[879px]`}>
			...
			<div className={`grid grid-flow-col mx-auto desktop:mt-[92px] desktop:w-[1198px] desktop:h-[461px] desktop:gap-x-[20px]`}>
				...
				<div className={`desktop:w-[386px] desktop:h-[461px]`}>
					...
					<div className={`font-sans font-normal text-center text-[#3C221B] desktop:text-[26px] desktop:leading-[38px]`}>每個關卡各 2 名，<br />設計 1 名、前端 1 名</div>
				</div>
				<div className={`relative desktop:w-[386px] desktop:h-[461px]`}>
					...
					<div className={`font-sans font-normal text-center text-[#3C221B] desktop:text-[26px] desktop:leading-[38px] desktop:mt-[11px]`}>每個關卡個人組十位<br />、團體組十組</div>
				</div>
			</div>
