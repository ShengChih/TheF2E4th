...
const SignPalette = ({ changeColor, defaultColor }: SignPaletteProps) => (
  <div
  ...
  >
    <div
      ...
      className={flatClassName({
        common: `${
          defaultColor === 'black' ? 'border-2 bg-white border-black' : ''
    ...
    <div
      ...
      className={flatClassName({
        common: `${
          defaultColor === '#0014C7' ? 'border-2 bg-white border-[#0014C7]' : ''
        } rounded-full flex items-center justify-center`,
        mobile: `sm:w-[45px] sm:h-[45px]`,
        tablet: `md:w-[45px] md:h-[45px]`,
        desktop: `xl:w-[45px] xl:h-[45px]`,
    ...
    <div
      ...
      className={flatClassName({
        common: `${
          defaultColor === '#CA0000' ? 'border-2 bg-white border-[#CA0000]' : ''
        } rounded-full flex items-center justify-center`,
        mobile: `sm:w-[45px] sm:h-[45px]`,
        tablet: `md:w-[45px] md:h-[45px]`,
        desktop: `xl:w-[45px] xl:h-[45px]`,
